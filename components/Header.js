    ...
    <header className="sticky top-0 bg-white">
      <div className="flex w-full items-center p-6">
        ...
        <form className="ml-10 mr-5 flex max-w-3xl flex-grow items-center rounded-full border border-gray-200 px-6 py-3 shadow-lg">
          ...
          />
          <MicrophoneIcon className="mr-3 hidden h-6 cursor-pointer border-l-2 border-gray-300 pl-4 text-blue-500 sm:inline-flex" />
        ...
        <svg
          className="ml-auto hidden h-10 w-10 cursor-pointer rounded-full fill-[#5f6368] p-2 hover:bg-gray-100 sm:inline-flex"
          focusable="false"
        ...
        <Avatar
          className="ml-3"
          url="https://dillonb07.is-a.dev/static/images/DillonB07.png"
        />
      </div>
