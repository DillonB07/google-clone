export default {
  ...
  searchInformation: {
    ...
    totalResults: '1410000000',
    formattedTotalResults: '1,410,000,000',
  },
  items: [
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQVIWA6ansZyB4bO1UorpBAPNQWg88S4ES8adRVcCK9n_Ik7NaAsfEvV30',
            width: '275',
            height: '183',
          },
        ],
        ...
        cse_image: [
          {
            src: 'https://static1.squarespace.com/static/56f18ec601dbae5d39d46fe8/t/5a76272a71c10bcbfb5544bf/1517692714590/HWS-6979.jpg',
          },
        ],
      },
    },
    {
      ...
      pagemap: {
        ...
        organization: [
          {
            name: 'Hello World',
            logo: 'https://cdn.shopify.com/s/files/1/0043/9642/files/PACKINGSLIP_Logo_DoNotDelete_230x.png?v=1630856259',
        ...
        metatags: [
          {
            ...
            'csrf-token': 'C1PEdTP8-FJoHG1aGRv1IO90YPwPY6f5RxNc',
            'og:url':
              'https://docs.github.com/en/get-started/quickstart/hello-world',
            status: '200',
          },
    ...
    },
    {
      ...
      snippet:
        "Hello World. The smallest React example looks like this: ReactDOM.render( <h1>Hello, world!</h1>, document.getElementById('root') );.",
      htmlSnippet:
        '<b>Hello World</b>. The smallest React example looks like this: ReactDOM.render( &lt;h1&gt;Hello, world!&lt;/h1&gt;, document.getElementById(&#39;root&#39;) );.',
    ...
    },
    {
      ...
      htmlFormattedUrl: 'https://www.<b>helloworld</b>devs.com/',
      pagemap: {
        cse_thumbnail: [
          {
